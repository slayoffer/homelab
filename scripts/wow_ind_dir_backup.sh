...
SOURCE_DIR="/home/slayo/docker/wow-vanilla"
...
BACKUP_FILENAME="wow-vanilla-backup-$DATE.tar.gz"

# Create a GZIP compressed tar archive of the source directory
sudo tar -czf "$BACKUP_DIR/$BACKUP_FILENAME" "$SOURCE_DIR"

# Delete backups older than DAYS
sudo find $BACKUPDIR -name "wow-vanilla-backup*tar.gz" -daystart -mtime +$DAYS -delete
